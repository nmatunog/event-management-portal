  ...
  return (
    <div className="public-landing relative min-h-[100dvh] text-zinc-900 overflow-x-hidden bg-zinc-100">
      ...
      <header className="sticky top-0 z-30 border-b border-zinc-200/90 bg-white/95 backdrop-blur-md shadow-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 py-4 flex flex-wrap items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-3 min-w-0 group">
            <div className="rounded-xl bg-white border border-zinc-200 flex items-center gap-2 px-2.5 py-2 shadow-sm shrink-0">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-8 pb-20">
        ...
        <section className="pt-10 sm:pt-14 lg:pt-16 grid lg:grid-cols-[1fr_min(48%,460px)] gap-10 lg:gap-12 items-start">
          <div className="order-2 lg:order-1 h-full flex flex-col">
            <div className="w-full max-w-[460px]">
              <div className="relative overflow-hidden rounded-3xl border border-white shadow-2xl shadow-zinc-900/10 ring-1 ring-black/5 bg-white aspect-[3/4] p-5 sm:p-6 flex flex-col">
                <img
